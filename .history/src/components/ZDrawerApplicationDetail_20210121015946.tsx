...
import { ITrackingDetailsUpdate } from '../models/TrackingDetailsModel';
import { ContainerService } from '../models_services/ContainerService';
import { useAppStore } from '../models_stores/appStore';
import ZSwitchListTile from './ZSwitchListTile';
import ZTextFormFieldDropdown from './ZTextFormFieldDropdown';
...
const ZDrawerContainerDetail: React.FC<Props> = ({ openDrawer, setOpenDrawer, container }) => {
...
ZDrawerContainerDetail.defaultProps = {};

export default ZDrawerContainerDetail;
