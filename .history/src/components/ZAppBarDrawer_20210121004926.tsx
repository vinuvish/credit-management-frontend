        ...
        <div className={classes.drawerContainer}>
          {authUser && authUser?.isAdmin && (
            <>
              ...
              <ZLinkItem to={'/ctracker'} selected={h.location.pathname === '/ctracker' || h.location.pathname === '/'} icon={BsInbox} title={'Containers'} />
              ...
              <ZLinkItem to={'/locations'} selected={h.location.pathname === '/locations'} icon={MdLocationCity} title={'Locations'} />
            </>
          )}
        </div>
      </Drawer>
