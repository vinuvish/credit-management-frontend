                        ...
                        <TableBody>
                            {application?.paymentPlans?.map((plan) => (
                                <TableRow >
                                    ...
                                    <TableCell align='left'>{plan.firstName}</TableCell>
                                    <TableCell align='left'>{plan.lastName}</TableCell>
                                    <TableCell align='left'>{plan.phone}</TableCell>
                                    <TableCell align='left'>{plan.email}</TableCell>
